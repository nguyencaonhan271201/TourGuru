                            ...
                            <div id="date-search-div" class="col-md-5 col-sm-12 d-flex p-0 mb-sm-2">
                                <div class="input-block">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <input type="text" name="depart" id="depart" placeholder="depart" onfocusin="(this.type='date')" onfocusout="(this.type='text')">
                                    </span>
                                </div>
                                <div class="input-block right-most">
                                    <span class="d-flex align-items-center">
                                        <i class="fas fa-calendar ml-2 mr-2"></i>
                                        <input type="text" name="arrival" id="arrival" placeholder="return" onfocusin="(this.type='date')" onfocusout="(this.type='text')">
                                    </span>
                                </div>
                            </div>
