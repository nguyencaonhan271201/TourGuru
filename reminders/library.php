...
define("SMTP_UNAME", "tourgurubycntt@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "teamCNTT"); //Password for SMTP authentication
