...
const validateAndSignUp = () => {
  ...
  let businessType = parseInt(
    document.getElementById("sign-up-business-type").value
  );
  ...
  if (businessType !== 0 && businessType !== 1) {
    let businessTypeInvalid = signUpForm.querySelector(
...
const updateToDatabaseNormalLogin = (data) => {
  ...
  xhr.open("POST", "../../api/business/auth/auth.php", true);
