...
<html lang="en">
    <head>
        <title>Tour Guru | Blogs | Edit Post</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container-fluid pb-4" style="padding-top: 40px;">
            <div class="main-container">
                <form id="create-post-form" method="post" action="index.php">
                    ...
                    <div class="text-left">
                        <button type="submit" id="btn-create" class="text-center mr-1">edit post</button>
                        <button type="button" id="btn-delete" class="text-center ml-1 mr-1">delete post</button>
                        <button id="btn-cancel" class="text-center mr-1">cancel</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <script src="./../create/TourGuruUploadAdapter.js"></script>
