<?php
  ...
  //var_dump(executeReturnObjects($result, "Y"));
  //var_dump(executeReturnObjects($result, "Q"));
  //var_dump(executeReturnObjects($result, "M"));
  //var_dump(executeReturnObjects($result, "W"));
  ...
  function executeReturnObjects($list, $period) {
    ...
    if ($period == "Y") {
      ...
      while (count($identifiers) != 12) {
        ...
        $pushObject->week = weekOfMonth($get);
      ...
      foreach ($identifiers as $identifier) {
        $pushObject = new stdClass();
        $pushObject->momth = $identifier->month;
