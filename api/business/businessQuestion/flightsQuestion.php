<?php
  ...
  if (isset($_POST["business_code"]) && isset($_POST["userID"]) && isset($_POST["text"])) {
    //Having all the params
    $business = $_POST['business_code'];
    $userID = $_POST['userID'];
    $content = $_POST["text"];

    //Get the business id
    $query = "SELECT business_id FROM businesses WHERE business_code = ?";
  ...
  } else if (isset($_GET["business_code"]) && isset($_GET["offset"])) {
    //Having all the params
    $business = $_GET['business_code'];
    $offset = $_GET['offset'];
