...
function ContextMenu(contextContainerID, menuItemClickCallback, options) {
  ...
  this.contextMenuContainer = $(
    '.context-menu[data-container-id="' + contextContainerID + '"]'
  );
  var self = this;
  var parent = $(this);
  this.contextMenuContainer.click(function (e) {
    ...
    var menuPos = {
      //   left: e.clientX - contextMenu.width() - 15,
      //   top: contextMenu.offset().top + e.clientY,
      left: e.pageX - contextMenu.width() - 10,
      top: e.pageY + 10,
    };
  ...
  this.returnContextMenu = function () {
    ...
    if (typeof self.contextMenu !== "undefined") {
      ...
      var contextMenuContainer = $(
        '.context-menu[data-container-id="' + this.contextContainerID + '"]'
      );
